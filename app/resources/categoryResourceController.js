...
exports.getCategories = (req, res, next) => {
    ...
    cs.findAllPag(req.params.pag, null)
        .then(category => {
...
exports.getCategory = (req, res, next) => {
    cs.findById(req.params.category_id)
        .then(category => {
            res.json(category);
        })
        .catch(err => {
...
exports.getCategoriesInProduct = (req, res, next) => {
    cs.findByCategoryFromProduct(req.params.product_id)
        .then(categories => {
            res.json(categories);
        })
        .catch(err => {
...
exports.getCategoriesInDepartment = (req, res, next) => {
    cs.findCategoryByDepartment(req.params.department_id)
        .then(categories => {
            res.json(categories);
        })
        .catch(err => {
